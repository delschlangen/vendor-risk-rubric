...
*Print this one-pager — or use the calculator at https://delschlangen.com/vendor-risk-rubric/*
...
[Full rubric](../rubric/risk_rubric.md) · [Decision tree](../rubric/decision_tree.md) · [Clause library](../clauses/contract_clauses.md) · [Assessment template](../templates/blank_assessment.md) · [Calculator guide](calculator_guide.md) · Calculator: https://delschlangen.com/vendor-risk-rubric/

...
The interactive calculator at **https://delschlangen.com/vendor-risk-rubric/** is a static web page implementing the six-dimension risk rubric. It runs offline and from a file share; nothing is sent to a server — drafts are kept only in your browser and in the link you copy.
